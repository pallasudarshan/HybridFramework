...
//	private WebElement assignedByDropdownBtn;
	...
	@FindAll({ @FindBy(xpath = "(//span[@title='Doctor Name']/following-sibling::span)[2]"),
			@FindBy(xpath = "//label[text()='Assigned By']/..//span[@title='Doctor Name']/following-sibling::span") })
	private WebElement assignedByDropdownBtn;
	...
	public void ifRemindLaterVisibleClose_Or_SignReportClose(WebDriver driver, String doctorName) throws Throwable {
	...
	public void loginToApplication(String url, String username, String password, WebDriver driver) throws Throwable {
		explictWaitForElementToBeVisible(driver, userNameText);
		userNameText.sendKeys(username);
		nextBtn.click();
		explictWaitForElementToBeVisible(driver, passwordText);
	...
	public void loginToApplicationUsingDoctorLoginForPgAndHIMO(String un, String pw, WebDriver driver,
		...
		loginBtn.click();
		clickOnLoginAnywayBtnIfDisplays(driver);
		ifRemindLaterVisibleClose_Or_SignReportClose(driver, doctorName);
	}
