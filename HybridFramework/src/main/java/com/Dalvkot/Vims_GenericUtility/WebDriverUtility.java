...
//	public void clickOnTheElementByUsingJavascriptExecuter(WebDriver driver, WebElement element) throws Throwable {
//		JavascriptExecutor js = (JavascriptExecutor) driver;
//		js.executeScript("arguments[0].click();", element);
//	}
...
//
	public void dropdown2(WebDriver driver, WebElement element, WebElement Text, String str) throws Throwable {
//		explicitWaitElementToBeClickable(driver, element);
		scrollDownThePageUntilTheElementIsVisibleUsingTheActionClass(driver, element);
		element.click();
		moveToElementAndEnterTheData(driver, Text, str);
	}
